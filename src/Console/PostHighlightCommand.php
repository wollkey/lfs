...
#[AsCommand(name: 'bot:post-highlight', description: 'Post the weekly film spotlight (latest rated film, top & bottom voters) to Telegram.')]
final class PostHighlightCommand extends Command
{
